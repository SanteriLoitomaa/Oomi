...
\section{a-kohta}
\label{a-kohta}
Luokka lopputeksti sisältää intit rivimäärällä ja max merkkimäärän, sen lisäksi
String Arrayn jossa on kaikki kirjoitettava teksti. Luokassa on erikseen metodi
yksittäisten rivien merkkimäärän tarkistukseen ja koko lopputeksti olion
tarkastukseen. Näiden lisäksi on mukana metodit tekstin lukemiseen ja muokkaamiseen.
\begin{javacode}
...
Metodi piirräKirjainKerralla piirtää lopputeksti olion kirjaimia yksi
